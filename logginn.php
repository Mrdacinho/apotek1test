      ...
      <div class="forelder">
        ...
        >
          ...
          <polygon
            ...
            fill="#2f2e41"
          />
          <circle cx="707.33457" cy="77.37523" r="77.37523" fill="#00796b" />
          <path
        ...
        <form action="php/login.php" method="post">
          <div class="skjema_tittel">
            <h2>Velkommen tilbake!</h2>
            <p>Logg inn på Finn Medisin</p>
          </div>
          <div class="sec1_4_form_element2">
            <label for="">E-post</label>
            <input
              class="sec1_4_input"
              type="email"
              placeholder="Tast inn ditt e-post"
              name="email"
              required
            />
          </div>
          <div class="sec1_4_form_element2">
            ...
            <input
              class="sec1_4_input"
              type="password"
              placeholder="Tast inn ditt passord"
              name="password"
              required
            />
          </div>
          <div class="sec1_4_form_element3">
            <input type="submit" value="logg inn" />
          </div>
          <div class="sec1_4_form_element4">
            <p class="left_p_sec1_4"><a href="">Glemte passord?</a></p>
            <p class="right_p_sec1_4"><a href="">Ny bruker?</a></p>
          </div>
        </form>
      </div>
    </section>
